...
// function flattenBoard(boardInput) {
//   return boardInput.flat();
// }
...
export function initialPlacement() {
  ...
  //white main pieces
  placePiece(board[7][0], playerBlack.pieces[4]);
  placePiece(board[7][1], playerBlack.pieces[3]);
  placePiece(board[7][2], playerBlack.pieces[2]);
  placePiece(board[7][3], playerBlack.pieces[1]);
  placePiece(board[7][4], playerBlack.pieces[0]);
  placePiece(board[7][5], playerBlack.pieces[2]);
  placePiece(board[7][6], playerBlack.pieces[3]);
  placePiece(board[7][7], playerBlack.pieces[4]);
}
